  ...
  return (
    <div className="min-h-screen" style={{ fontFamily: "var(--app-font-mono)" }}>
      ...
      >
        ...
        <div className="relative z-10 px-8 md:px-16 max-w-3xl bg-[#4a4a4a4d] text-[#e9e3d8]">
          <div
            className="animate-fade-in-up mb-3 text-xs tracking-[0.28em] uppercase text-right"
          ...
          <p
            className="animate-fade-in-up mb-10 tracking-[0.15em] text-[14px] text-right bg-[#00000000] border-t-[#dae8be] border-r-[#dae8be] border-b-[#dae8be] border-l-[#dae8be] border-t-[1px] border-r-[1px] border-b-[1px] border-l-[1px] font-normal text-[#e9e3d8]"
